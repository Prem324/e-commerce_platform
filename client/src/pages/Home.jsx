      ...
      <div className="space-y-16 md:space-y-24 pb-24">
          ...
          <div className="relative z-10 container mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-sm md:text-lg text-slate-300 mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed">
                Discover our curated collection of high-quality products. We
                focus on design, functionality, and your satisfaction.
              </p>
        ...
        <section>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 md:mb-12 gap-4">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-1 md:mb-2 dark:text-white">
                Featured Products
              </h2>
          ...
          {loading ? (
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="animate-pulse bg-slate-100 dark:bg-slate-800 rounded-3xl aspect-[4/5]"
                />
              ))}
            </div>
          ) : (
          ...
          {[
            {
              icon: <Truck size={28} />,
              title: "Free Shipping",
              desc: "Enjoy complimentary delivery on all orders over $100.",
            },
            {
              icon: <ShieldCheck size={28} />,
              title: "Secure Checkout",
              desc: "Your data is protected by industry-standard encryption.",
            },
            {
              icon: <Zap size={28} />,
              title: "Fast Support",
              desc: "Our team is here to help you 24/7 with any inquiries.",
            },
          ].map((feature, i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-900 p-10 rounded-3xl border border-slate-100 dark:border-slate-800 text-center hover:shadow-lg transition-transform hover:-translate-y-1"
            >
