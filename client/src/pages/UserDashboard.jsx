                  ...
                  <div className="grow">
                    ...
                    <div className="space-y-2">
                      {order.orderItems.map((item, idx) => (
                        ...
                        >
                          Product ID: {item.product.slice(-6)}... x{" "}
                          {item.quantity}
                        </p>
                      ))}
                    </div>
                  </div>
                  <div className="min-w-50 border-t md:border-t-0 md:border-l border-slate-100 dark:border-slate-800 pt-4 md:pt-0 md:pl-6">
                    <p className="text-[10px] text-slate-400 dark:text-slate-500 uppercase font-bold tracking-widest mb-2">
                      Shipping to
                    </p>
